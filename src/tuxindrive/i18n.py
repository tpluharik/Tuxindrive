...
_STRINGS = {
    ...
    "de": {
        ...
        "open_folder": "Ordner öffnen", "open_online_folder": "Online-Ordner öffnen", "share_link": "Freigabelink erstellen", "history": "Verlauf", "verify": "Prüfen",
    ...
    "fr": {
        ...
        "open_folder": "Ouvrir le dossier", "open_online_folder": "Ouvrir le dossier en ligne", "share_link": "Créer un lien de partage", "history": "Historique", "verify": "Vérifier",
    ...
    "es": {
        ...
        "open_folder": "Abrir carpeta", "open_online_folder": "Abrir carpeta en línea", "share_link": "Crear enlace compartido", "history": "Historial", "verify": "Verificar",
    ...
    "ar": {
        ...
        "open_folder": "فتح المجلد", "open_online_folder": "فتح المجلد عبر الإنترنت", "share_link": "إنشاء رابط مشاركة", "history": "السجل", "verify": "تحقق",
    ...
    "he": {
        ...
        "open_folder": "פתיחת תיקייה", "open_online_folder": "פתיחת תיקייה בענן", "share_link": "יצירת קישור שיתוף", "history": "היסטוריה", "verify": "אימות",
