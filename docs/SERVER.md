...
The 0.26.24 cross-folder filename index remains entirely on each desktop
...
Download `tuxindrive-server_0.26.24_all.deb` from the matching
[GitHub Release](https://github.com/tpluharik/Tuxindrive/releases/tag/v0.26.24),
...
installing 0.26.24 replaces its launcher and completes the pending package
...
dpkg-deb --info dist/tuxindrive-server_0.26.24_all.deb
dpkg-deb --contents dist/tuxindrive-server_0.26.24_all.deb
sudo apt install ./dist/tuxindrive-server_0.26.24_all.deb
```
