...
The 0.26.25 cross-folder filename index remains entirely on each desktop
...
Download `tuxindrive-server_0.26.25_all.deb` from the matching
[GitHub Release](https://github.com/tpluharik/Tuxindrive/releases/tag/v0.26.25),
...
installing 0.26.25 replaces its launcher and completes the pending package
...
sudo apt install ./dist/tuxindrive-server_0.26.25_all.deb
```
