...
dpkg-deb --info dist/tuxindrive_0.26.33_all.deb
dpkg-deb --contents dist/tuxindrive_0.26.33_all.deb
sha256sum dist/tuxindrive_0.26.33_all.deb
```
...
```bash
python3 scripts/sign-update.py --version 0.26.33 \
  --package dist/tuxindrive_0.26.33_all.deb \
...
dpkg-deb --info dist/tuxindrive-server_0.26.33_all.deb
dpkg-deb --contents dist/tuxindrive-server_0.26.33_all.deb
