...
class PackagingTests(unittest.TestCase):
    ...
    def test_tray_animation_frames_are_valid_and_packaged(self):
        ...
        for frame in range(8):
            ...
            self.assertIn('viewBox="0 0 520 288"', content)
            self.assertIn('r="144"', content)
            self.assertIn("triple-size indicator", content)
        ...
        self.assertIn('viewBox="0 0 340 256"', error_content)
        self.assertIn("next to the main icon", error_content)
